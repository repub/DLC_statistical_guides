  ...
  <ul class="toc_list">
    ...
    <a href="#checking-assumptions">Checking assumptions</a><br>
       ...
       <a href="#outliers">&emsp;Outliers</a><br>
         <a href="#multivariate-outliers">&emsp;&emsp;Multivariate outliers</a><br>
         <a href="#univariate-outliers">&emsp;&emsp;Univariate outliers</a><br>
       <a href="#normality">&emsp;Normality</a><br>
         <a href="#multivariate-normality-test">&emsp;&emsp;Multivariate normality test</a><br>
         <a href="#univariate-normality-test">&emsp;&emsp;Univariate normality test</a><br>
    ...
    <a href="#one-way-manova">One-way MANOVA</a><br>
      <a href="#post-hoc-anova">&emsp;Post-hoc ANOVA</a><br>
      <a href="#post-hoc-pairwise-comparisons">&emsp;Pos-hoc pairwise comparisons</a><br>
    <a href="#two-way-manova">Two-way MANOVA</a><br>
      <a href="#post-hoc-anova2">&emsp;Post-hoc ANOVA</a><br>
      <a href="#post-hoc-pairwise-comparisons2">&emsp;Pos-hoc pairwise comparisons</a><br>
  </ul>
  </div>
</aside>
