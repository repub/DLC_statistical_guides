...
&emsp;When our response variable has only two outcomes (binary), such as *agree* and **disagree* or *yes* and *no*, we can estimate the log of odds for which of the two outcomes an observation may fall in from a set of predictors using binary logistic regression.  The assumptions for logit regression include:
