...
&nbsp;
<center><i>H<sub>A</sub>: &#961; &#8800; 0, or H<sub>A</sub>: &#961; &gt; 0 or &#961; &lt; 0</i></center>
&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp; fit a linear regression model we can use the `lm()` function in R where the response variable is to the left of, and predictor variable to the right of a `~` as follows:
