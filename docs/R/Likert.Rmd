...
&emsp;When our goal is to survey a group of individuals opinion toward a certain item or concept we can use scale-based approaches, the most common of which is Likert scale questions.  Likert question an individual's attitude toward a number of specific items along a 5 or more point scale with choices ranging from negative to positive attitudes toward the topic.  Commonly, Likert scales follow the following syntax:
