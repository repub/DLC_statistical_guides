...
&emsp;With Fisher's exact test we are testing whether the counts in each row are dependent on which column they belong (or that the rows and columns are independent from one another).  We can phrase our statistical hypotheses as follows:
...
&emsp;Before using Fisher's exact test to evaluate these hypotheses, we should determine whether the following [assumptions](https://online.stat.psu.edu/stat504/lesson/3/3.3) are valid.
...
<table>
  <tbody>
    <tr>
      <td></td>
      <td><b><center>Magnesium</b></center></td>
      <td><b><center>Placebo</b></center></td>
    </tr>
    <tr>
