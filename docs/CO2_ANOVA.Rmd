...
$$y_{i,Uptake} = \beta_0 + \beta_1x_{i,Concentration} + \beta_2x_{i,Treatment} + \beta_3x_{i,Type} + \epsilon_i$$
...
$$y_{i,Uptake} = 29.260 + 0.018x_{i,Concentration} - 6.860x_{i,Treatment} - 12.660x_{i,Type}$$
