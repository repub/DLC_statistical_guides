...
<i>y<sub>i</sub> = &beta;<sub>0</sub> + &beta;<sub>1</sub>x<sub>i,1</sub> + &beta;<sub>2</sub>x<sub>i,2</sub> + ... + &beta;<sub>n</sub>x<sub>i,n</sub> + &epsilon;<sub>i</sub></i>
...
$$y_i = {\beta}_0 + {\beta}_1 x_{i,1} + {\beta}_2 x_{i,2}... + {\beta}_n x_{i,n}$$
