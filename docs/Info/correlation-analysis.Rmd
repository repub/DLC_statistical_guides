...
<center><i>H<sub>0</sub></i>: There is no linear correlation between the two variables (<i>&rho; = 0).</center>
<center><i>H<sub>a</sub></i>: There is no linear correlation between the two variables (<i>&rho; ≠ 0).</center>
<br>
...
<center><i>H<sub>0</sub></i>: There is no monotonic relationship between the two variables (<i>&rho; = 0).</center>
<center><i>H<sub>a</sub></i>: There is no monotonic relationship between the two variables (<i>&rho; ≠ 0).</center>
<br>
