...
Typically, we would load our data into R from a previously generated file, but for this example we can manually input the data into a data frame with the following code.
