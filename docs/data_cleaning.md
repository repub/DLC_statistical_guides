...
```
    ...
    ##   X            brewery_name review_time review_aroma review_appearance               beer_style
    ## 1 1  Tröegs Brewing Company  1275968124          3.0               4.5            Oatmeal Stout
    ## 2 2 Victory Brewing Company  1182930981          4.5               4.0             American IPA
    ## 3 3 Victory Brewing Company  1193519101          4.0               1.5                   Tripel
    ## 4 4 Victory Brewing Company  1157967909          4.5               4.0             American IPA
    ## 5 5 Victory Brewing Company  1263695148          3.5               4.0             American IPA
    ## 6 6  Tröegs Brewing Company  1204151979          5.0               4.0 American Amber / Red Ale
    ##   review_palate review_taste              beer_name beer_abv
    ## 1           3.5          3.0 Tröegs Java Head Stout      7.5
    ## 2           4.0          4.5           HopDevil Ale      6.7
    ## 3           4.0          4.0          Golden Monkey      9.5
    ## 4           3.5          4.0           HopDevil Ale      6.7
    ## 5           3.5          4.0           HopDevil Ale      6.7
    ## 6           4.0          4.5   Tröegs Nugget Nectar      7.5
...
```
    ...
    ## 2019                    Belgian IPA             3          3.0    Wild Devil      6.7
    ## 2020 American Double / Imperial IPA             4          4.5    Hop Wallop      8.5
    ## 2021                         Tripel             4          3.0 Golden Monkey      9.5
...
```
    ...
    ##  [1] "X"                 "brewery_name"      "review_time"       "review_aroma"     
    ##  [5] "review_appearance" "beer_style"        "review_palate"     "review_taste"     
    ##  [9] "beer_name"         "beer_abv"
...
```
    ...
    ## [1] "brewery_name"      "review_time"       "review_aroma"      "review_appearance"
    ## [5] "beer_style"        "review_palate"     "review_taste"      "beer_name"        
    ## [9] "beer_abv"
...
```
    ...
    ##  Length:2021        Min.   :1.013e+09   Min.   :1.000   Min.   :1.500     Length:2021       
    ##  Class :character   1st Qu.:1.168e+09   1st Qu.:3.500   1st Qu.:3.500     Class :character  
    ##  Mode  :character   Median :1.240e+09   Median :4.000   Median :4.000     Mode  :character  
    ##                     Mean   :1.220e+09   Mean   :3.813   Mean   :3.918                       
    ##                     3rd Qu.:1.284e+09   3rd Qu.:4.000   3rd Qu.:4.000                       
    ##                     Max.   :1.326e+09   Max.   :5.000   Max.   :5.000                       
    ##                                                                                             
    ##  review_palate    review_taste    beer_name            beer_abv     
    ##  Min.   :1.000   Min.   :1.000   Length:2021        Min.   : 3.300  
    ##  1st Qu.:3.500   1st Qu.:3.500   Class :character   1st Qu.: 5.300  
    ##  Median :4.000   Median :4.000   Mode  :character   Median : 7.000  
    ##  Mean   :3.847   Mean   :3.907                      Mean   : 7.281  
    ##  3rd Qu.:4.000   3rd Qu.:4.500                      3rd Qu.: 8.700  
    ##  Max.   :5.000   Max.   :5.000                      Max.   :89.000  
    ##                                                     NA's   :17
...
```
    ...
    ##  $ brewery_name     : chr  "Tröegs Brewing Company" "Victory Brewing Company" "Victory Brewing Company" "Victory Brewing Company" ...
    ...
    ##  $ beer_style       : chr  "Oatmeal Stout" "American IPA" "Tripel" "American IPA" ...
    ##  $ review_palate    : num  3.5 4 4 3.5 3.5 4 3.5 4.5 3.5 4 ...
    ##  $ review_taste     : num  3 4.5 4 4 4 4.5 4 4.5 3.5 4 ...
    ##  $ beer_name        : chr  "Tröegs Java Head Stout" "HopDevil Ale" "Golden Monkey" "HopDevil Ale" ...
...
```
    ...
    ##  [1] 2001 2002 2003 2004 2005 2006 2007 2008 2009 2010 2011 2012 2013 2014 2015 2016 2017 2018 2019
    ## [20] 2020 2021
...
```
    ...
    ## 121 Victory Brewing Company  1325017838          3.5                 4     Tripel           3.5
    ##     review_taste         beer_name beer_abv
    ## 121            3 Tettnager Trippel       89
...
```
    ...
    ## [1] "brewery"    "time"       "aroma"      "appearance" "style"      "palate"     "taste"     
    ## [8] "name"       "abv"
...
```
    ...
    ##         time                 brewery                   name         style abv aroma appearance
    ## 1 1275968124  Tröegs Brewing Company Tröegs Java Head Stout Oatmeal Stout 7.5   3.0        4.5
    ## 2 1182930981 Victory Brewing Company           HopDevil Ale  American IPA 6.7   4.5        4.0
    ## 3 1193519101 Victory Brewing Company          Golden Monkey        Tripel 9.5   4.0        1.5
    ##   palate taste
    ## 1    3.5   3.0
    ## 2    4.0   4.5
    ## 3    4.0   4.0
...
```
    ...
    ##            time            brewery                           name               style abv aroma
    ## 1558 1013459463 Yuengling Brewery           Yuengling Black & Tan         Black & Tan 4.7   4.0
    ## 1669 1013692542 Yuengling Brewery  Yuengling Porter (Dark Brewed)     American Porter 4.7   3.0
    ## 1172 1013956672 Yuengling Brewery          Yuengling Premium Beer American Pale Lager 4.4   3.5
...
```
    ...
    ##         time            brewery                           name               style abv aroma
    ## 1 1013459463 Yuengling Brewery           Yuengling Black & Tan         Black & Tan 4.7   4.0
    ## 2 1013692542 Yuengling Brewery  Yuengling Porter (Dark Brewed)     American Porter 4.7   3.0
    ## 3 1013956672 Yuengling Brewery          Yuengling Premium Beer American Pale Lager 4.4   3.5
    ##   appearance palate taste
    ## 1          5    4.0   4.5
    ## 2          4    3.5   3.5
    ## 3          4    3.5   4.0
...
```
    ...
    ##            time                 brewery                  name                   style abv aroma
    ## 1998 1325767873  Tröegs Brewing Company       Tröegs Pale Ale American Pale Ale (APA) 5.4   3.5
    ## 1999 1326068736 Victory Brewing Company         Dark Intrigue  Russian Imperial Stout 9.1   4.0
    ## 2000 1326221853      Yuengling Brewery  Yuengling Light Lager             Light Lager 3.4   3.0
    ##      appearance palate taste
    ## 1998          4    4.0   4.0
    ## 1999          4    4.0   4.0
    ## 2000          3    2.5   2.5
...
```
    ...
    ## 2 1013692542 Yuengling Brewery  Yuengling Porter (Dark Brewed)     American Porter 4.7   3.0
    ## 3 1013956672 Yuengling Brewery          Yuengling Premium Beer American Pale Lager 4.4   3.5
    ##   appearance palate taste total average
    ## 1          5    4.0   4.5  17.5   4.375
    ## 2          4    3.5   3.5  14.0   3.500
    ## 3          4    3.5   4.0  15.0   3.750
...
Another problem we will commonly run across is mislabeled data, either mislabeled when the data was originally recorded or possibly during some format conversion. As we can see in our data some of our mislabeling probably fall in the later category. In particular, the "o" with an umlaut (ö) in the name Tröegs is replaced with other characters. We could try to fix this by adding back the ö, however we could continue to run into the same issue down the road and it would be much easier to just change it to a regular "o" for data analysis.
...
```
    ...
    ## [1] "Yuengling Brewery"       "Yards Brewing Company"   "Victory Brewing Company"
    ## [4] "Tröegs Brewing Company"  "Voodoo Brewing Company"

On top of changing the special characters that represent the "ö" to an "o", we also removed the space after "Yuengling Brewery" and spelled out the full name for "Yards Brewing Company". If we left the space at the end of our factor name it could cause issues down the line if we try to call that level by name, and so to save the headache we should just change it now. Why spell out the full name for company and not just leave the abbreviation? Just to keep things consistent since the other levels had company spelled out. Alternatively, we could have abbreviated the other levels to "Co." to shorten the name with the same function.
...
While we fixed Tröegs in the `brewery` column, we still are not done yet! Tröegs likes to add their company name to their beer names as well, which we can see if we take a look at all of the beer names in the `name` variable. So, we can also replace the special characters with an "o" in this column as well. However, if we used our code above we would have to go through and change multiple beer names that include Tröegs, which would be time consuming. Instead, we can use [pattern matching](https://bookdown.org/rdpeng/rprogdatascience/regular-expressions.html) to make our life (and code) simpler.
...
```
    ...
    ##       time                                        brewery                              name     
    ##  Min.   :2002-02-11 15:31:03   Yuengling Brewery      : 186   HopDevil Ale               : 118  
    ##  1st Qu.:2006-12-27 09:01:46   Yards Brewing Company  : 103   Storm King Stout           : 116  
    ##  Median :2009-04-12 08:53:40   Victory Brewing Company:1007   Prima Pils                 : 105  
    ##  Mean   :2008-08-30 21:34:59   Tröegs Brewing Company : 646   Hop Wallop                 :  89  
    ##  3rd Qu.:2010-09-10 07:53:46   Voodoo Brewing Company :  58   Tröegs Nugget Nectar       :  88  
    ##  Max.   :2012-01-10 13:57:33                                  Yuengling Traditional Lager:  80  
    ##                                                               (Other)                    :1404  
    ##     style                abv             aroma         appearance        palate     
    ##  Length:2000        Min.   : 3.300   Min.   :1.000   Min.   :1.500   Min.   :1.000  
    ##  Class :character   1st Qu.: 5.300   1st Qu.:3.500   1st Qu.:3.500   1st Qu.:3.500  
    ##  Mode  :character   Median : 7.000   Median :4.000   Median :4.000   Median :4.000  
...
From the summary table, it looks like we ahve cleaned up a lot of the issues! We fixed the spelling of Tröegs, removed duplicated rows, and no longer have missing values. However, one thing to always keep in mind is that the summary table does not show you everything! For example, let us take a look at the `style` column using the `levels()` function.
...
```
    ...
    ## [1] "Märzen / Oktoberfest" "Oatmeal Stout"
